...
public class ItemImageFeedBindingImpl extends ItemImageFeedBinding implements com.semicolon.ddyzd_android.generated.callback.OnClickListener.Listener {
    ...
    public ItemImageFeedBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private ItemImageFeedBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        com.semicolon.ddyzd_android.adapter.FeedPagerAdapter vmFeedAdapterPageAdapter = null;
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            if ((dirtyFlags & 0xcL) != 0) {
                    ...
                    if (vmFeedAdapter != null) {
                        // read vm.feedAdapter.pageAdapter
                        vmFeedAdapterPageAdapter = vmFeedAdapter.getPageAdapter();
                    }
            }
        }
        // batch finished
