...
public class ItemScheduleChatBindingImpl extends ItemScheduleChatBinding  {
    ...
    public ItemScheduleChatBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ItemScheduleChatBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0xfL) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textView22, vmChattingListPositionMsg);
            com.semicolon.ddyzd_android.bindingadapter.ChattingBindingAdaper.timeAdapter(this.textView23, vmChattingListPositionCreatedAt);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textView6, vmChattingListPositionTitle);
        }
    }
